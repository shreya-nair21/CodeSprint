...
import { getAllProblems, getProblemById, createProblem, updateProblem, deleteProblem, toggleBookmark } from '../controllers/problems.controller.js';
...
router.get('/:id', optionalProtect, getProblemById);
